<?php
	...
	if ($input_digits == '1') {
        ...
        $response->addRedirect('http://' . $_SERVER["SERVER_NAME"] . /*':' . $_SERVER["SERVER_PORT"] .*/ '/pep/plivo-voicemail/confirm-input.php', array('method' =>'GET'));
	} else if ($input_digits == '2') { 
        $response->addRedirect('http://' . $_SERVER["SERVER_NAME"] . /*':' . $_SERVER["SERVER_PORT"] .*/ '/pep/plivo-voicemail/get-input.php', array('method' =>'GET'));
