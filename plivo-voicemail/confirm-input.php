<?php
	...
	$getdigits = $response->addGetDigits(array('action' => 'http://' . $_SERVER["SERVER_NAME"] . /*':' . $_SERVER["SERVER_PORT"] .*/ '/pep/plivo-voicemail/follow-action.php?RecordUrl=' . $record_url, 'method' => 'GET'));
